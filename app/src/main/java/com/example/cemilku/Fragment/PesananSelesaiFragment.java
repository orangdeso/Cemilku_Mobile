 ...
 * Use the {@link PesananMasukFragment#newInstance} factory method to
...
public class PesananSelesaiFragment extends Fragment {
    ...
    public static PesananMasukFragment newInstance(String param1, String param2) {
        PesananMasukFragment fragment = new PesananMasukFragment();
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View view=inflater.inflate(R.layout.fragment_pesanan_masuk, container, false);
        recyclerView=view.findViewById(R.id.recview);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        dataholder=new ArrayList<>();

        DataModel ob1=new DataModel(R.drawable.kentang1,"Android","Mobile Application");
        dataholder.add(ob1);
        ...
        DataModel ob12=new DataModel(R.drawable.pyton,"Python","Desktop and Web Programming");
        dataholder.add(ob12);
